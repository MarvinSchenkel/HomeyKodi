                                ...
                                if (resultGetItem.item.type === 'movie' || resultGetItem.item.type === 'movies') {
                                    ...
                                    this._kodiConnection.run('VideoLibrary.GetMovieDetails', movieParams)
                                        .then((movieResult) => {
                                            ...
                                            artUrl = (movieResult.moviedetails.art.poster) ? this._parseArtworkUrl(movieResult.moviedetails.art.poster) : ''
                                        })
                                        .catch(() => {
                                    ...
                                    this._kodiConnection.run('VideoLibrary.GetEpisodeDetails', episodeParams)
                                        .then((episodeResult) => {
                                            //console.log('result ', episodeResult.episodedetails.art['season.poster'])
                                            ...
                                            artUrl = (episodeResult.episodedetails.art['season.poster']) ? this._parseArtworkUrl(episodeResult.episodedetails.art['season.poster']) : ''
                                        })
                                        .catch((err) => {
